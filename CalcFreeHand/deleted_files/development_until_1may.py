...
# - thus it will asume the given string has passed char_correc as True
...
# user input here for the testing purposes
	...
	if check_s_bef_open_par(user_input):
		print('no errors before OPEN parenthesis')
	else: 
		print('errors found before OPEN parenthesis')
	if check_s_bef_closed_par(user_input):
		print('no errors before CLOSED parenthesis')
	else: 
		print('errors found before CLOSED parenthesis')
	input('Press enter: ')
